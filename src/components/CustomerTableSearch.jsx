...
import { Table, TableBody, TableCell, TableHead, TableRow, IconButton, styled, Typography } from '@mui/material';
  ...
  return (
    <>
      {filteredData.length === 0 ? (
        <Typography variant="h6" align="center" style={{ margin: '20px 0', color: 'blac' }}>
